...
var i_31428 = (0);
while(true){
if((i_31428 < arr.length)){
(arr[i_31428] = null);

var G__31429 = (i_31428 + (1));
i_31428 = G__31429;
continue;
} else {
}
...
var i_31437 = (self__.level + (1));
while(true){
if((i_31437 <= (new_level + (1)))){
(update[i_31437] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_31439 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31439[i]));
} else {
x__$2.forward.push((((i < links_31439.length))?(links_31439[i]):null));
}

if((i < links_31439.length)){
(links_31439[i] = x__$2);
} else {
links_31439.push(x__$2);
}
...
var i_31442 = (0);
while(true){
if((i_31442 <= self__.level)){
var links_31443 = (update[i_31442]).forward;
if((x__$1 === (((i_31442 < links_31443.length))?(links_31443[i_31442]):null))){
(links_31443[i_31442] = (x__$1.forward[i_31442]));

var G__31444 = (i_31442 + (1));
i_31442 = G__31444;
continue;
} else {
var G__31445 = (i_31442 + (1));
i_31442 = G__31445;
continue;
}
} else {
...
var G__31447 = nx;
var G__31448 = (level__$1 - (1));
x = G__31447;
level__$1 = G__31448;
continue;
} else {
var G__31449 = x;
var G__31450 = (level__$1 - (1));
x = G__31449;
level__$1 = G__31450;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31452 = nx;
var G__31453 = (level__$1 - (1));
x = G__31452;
level__$1 = G__31453;
continue;
} else {
var G__31454 = x;
var G__31455 = (level__$1 - (1));
x = G__31454;
level__$1 = G__31455;
continue;
}
