...
var G__29313 = o;
reagent.impl.template.goog$module$goog$object.set(G__29313,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__29332__i < G__29332__a.length) {G__29332__a[G__29332__i] = arguments[G__29332__i + 0]; ++G__29332__i;}
  args = new cljs.core.IndexedSeq(G__29332__a,0,null);
} 
...
var G__29314 = o;
reagent.impl.template.goog$module$goog$object.set(G__29314,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__29315 = props;
var G__29315__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29315,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29315);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29315__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__29316 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29316,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__29316;
}
})(),id_class);
...
var temp__5825__auto___29337 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___29337)){
var d_29338 = temp__5825__auto___29337;
if((d_29338 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_29338.s}));
} else {
...
var G__29317 = (cljs.core.count(argv) - first_child);
switch (G__29317) {
case (0):
...
var vec__29318 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29318,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29318,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29318,(2),null);
...
var temp__5829__auto___29340 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29340 == null)){
} else {
var key_29341 = temp__5829__auto___29340;
(jsprops.key = key_29341);
}
...
var temp__5829__auto___29342 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29342 == null)){
} else {
var key_29343 = temp__5829__auto___29342;
(jsprops.key = key_29343);
}
...
var temp__5829__auto___29344 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29344 == null)){
} else {
var key_29345 = temp__5829__auto___29344;
(jsprops.key = key_29345);
}
...
var temp__5829__auto___29346 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___29346 == null)){
} else {
var key_29347 = temp__5829__auto___29346;
(jsprops.key = key_29347);
}
...
var temp__5829__auto___29351 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___29351 == null)){
} else {
var key_29353 = temp__5829__auto___29351;
(jsprops.key = key_29353);
}
...
var temp__5829__auto___29356 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___29356 == null)){
} else {
var key_29357 = temp__5829__auto___29356;
(jsprops.key = key_29357);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29321_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__29321_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__29322 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29322,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29322,(1),null);
...
break;
default:
var G__29365 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__29366 = compiler;
v = G__29365;
compiler = G__29366;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template29328 = (function (opts,id,fn_to_element,parse_fn,meta29329){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template29328.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29330,meta29329__$1){
var self__ = this;
var _29330__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template29328(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta29329__$1));
}));

(reagent.impl.template.t_reagent$impl$template29328.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29330){
var self__ = this;
var _29330__$1 = this;
return self__.meta29329;
}));

(reagent.impl.template.t_reagent$impl$template29328.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template29328.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template29328.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template29328.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template29328.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template29328.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta29329","meta29329",1118853439,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template29328.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template29328.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template29328");

(reagent.impl.template.t_reagent$impl$template29328.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template29328");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template29328.
 */
reagent.impl.template.__GT_t_reagent$impl$template29328 = (function reagent$impl$template$__GT_t_reagent$impl$template29328(opts,id,fn_to_element,parse_fn,meta29329){
return (new reagent.impl.template.t_reagent$impl$template29328(opts,id,fn_to_element,parse_fn,meta29329));
});
...
return (new reagent.impl.template.t_reagent$impl$template29328(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
