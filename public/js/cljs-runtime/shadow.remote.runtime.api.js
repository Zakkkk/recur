...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31645 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31645(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31649 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31649(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31650 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31650(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31651 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31651(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31653 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31653(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31654 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31654(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31639,callback){
var map__31640 = p__31639;
var map__31640__$1 = cljs.core.__destructure_map(map__31640);
var input = map__31640__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31640__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31640__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
